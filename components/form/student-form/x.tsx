...
export function BasicInfoForm({ onNext, formData, setFormData }: StepProps) {
  ...
  const basicInfoForm = useForm<BasicInfoFormData>({
    ...
    defaultValues: {
      ...
      isPermanentId: formData.isPermanentId ?? true,
      hobbies: formData.hobbies || [],
      status: formData.status || "Tested",
      isSatsangi: formData.isSatsangi ?? true,
      isBAPSSatsangi: formData.isBAPSSatsangi ?? false,
      yearsOfSatsang: formData.yearsOfSatsang || 0,
    },
  });
...
//               </FormControl>
//               <FormDescription>
//                 Bed number in the assigned room.
//               </FormDescription>
//               <FormMessage />
//             </FormItem>
//           )}
